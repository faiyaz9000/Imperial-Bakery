...
<head>
    ...
    <title>Admin login Page | Imperial Bakery</title>
...
<body class="container-fluid" style="background-color:#95a5a6">
    <header>
...
<form action="admin.php"  class="myform" method="post">
    <label>Admin ID</label>
    <br>

    <input  name ="admin"  type="text" class="inputvalues" placeholder="Enter your ID" required/>
    <br>
    <label>Password</label>
    <br>
    <input name="password" type="password" class="inputvalues" placeholder="Enter your Password" required/>
    <br>
    <input name="adminpanel" type="submit" id="loginbtn" value="Login"/>
    <br>
